function [v1_mn,v1_mn_H] = force_fluid_test(GDof, numberRes,nnode,nelem,elem,nodes,...
          ...
          for uu = 1:nelem
              ...
              for cc =1:length(csi_aux)
                  for dd =1:length(eta_aux)
                      ...
                      f_fluid = aux_N2*exp(-1j*((kx_mn*x2)+(ky_mn*y2)))*detJ2+f_fluid;
                      f_fluid_H = aux_N2*exp(+1j*((kx_mn*x2)+(ky_mn*y2)))*...
                          detJ2+f_fluid_H;                  
